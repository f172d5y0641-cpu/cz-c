...
@section('title', 'Detail BAPP')

@section('content')

    <h1 class="text-3xl font-bold text-blue-900 mb-6 tracking-wide">Detail BAPP</h1>
    ...
    <div class="bg-white shadow-lg rounded-xl p-6 mb-8 border border-gray-200">
        ...
        <table class="w-full border-collapse">
            <tbody class="text-gray-800">
                ...
                <tr class="border-b">
                    <th class="p-3 bg-blue-50 font-medium">Nilai Pekerjaan</th>
    ...
    <div class="bg-white shadow-lg rounded-xl p-6 border border-gray-200">
        <h2 class="text-xl font-semibold text-blue-700 mb-4">Daftar Pekerjaan</h2>

        <div class="overflow-x-auto">
            <table class="w-full border-collapse">
                <thead>
                    <tr class="bg-blue-600 text-white text-sm">
                        <th class="p-3 text-left">Uraian Pekerjaan</th>
                        <th class="p-3 text-left">Spesifikasi / Volume</th>
                        <th class="p-3 text-left">Status Pekerjaan</th>
                        <th class="p-3 text-left">Keterangan</th>
                    </tr>
                </thead>
                <tbody class="text-gray-800">
                    @foreach ($dokumen->bapp as $item)
                        <tr class="border-b hover:bg-gray-50">
                            <td class="p-3">{{ $item->uraian_pekerjaan }}</td>
                            <td class="p-3">{{ $item->spesifikasi_volume }}</td>
                            <td class="p-3">{{ $item->status_pekerjaan }}</td>
    ...
    <div class="mt-8 flex justify-between">
        ...
        <div class="flex gap-4">
            <a href="#" onclick="openModal(this)" data-modal="#tanda-tangan-modal-bapp"
                data-pdf="{{ $pdfRenderUrl ?? ($pdfUrl ?? '') }}"
...
@push('modal')
    <div id="tanda-tangan-modal-bapp" data-modal="#tanda-tangan-modal-bapp" onclick="backdropClose(event)"
        ...
        <div class="bg-white p-6 rounded-xl shadow-lg w-11/12 max-h-[90vh] overflow-auto animate-scaleIn"
            ...
            <div class="flex justify-between items-center mb-4">
                ...
                <button onclick="closeModal(this)" data-modal="#tanda-tangan-modal-bapp"
            ...
            <form class="grid grid-cols-[3fr_1fr]" method="POST"
                ...
                <div class="mt-6 flex justify-end gap-2 col-span-2">
                    <button type="button" onclick="closeModal(this)" data-modal="#tanda-tangan-modal-bapp"
...
@push('scripts')
    <script>
        ...
        function canvasToImage() {
            ...
            if (draggable) {
                draggable.innerHTML =
                    `<img src="${dataUrl}" class="max-w-full max-h-full object-contain pointer-events-none" />`;
        ...
        function backdropClose(event) {
            if (event.target.id === "tanda-tangan-modal-bapp") {
